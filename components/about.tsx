        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24">
            ...
            <div>
              ...
              >
                <p>
                  Небольшая мастерская, где каждое украшение собирается 
                  вручную, без спешки и без повторов — сборка всегда 
                  в единственном экземпляре. Мы верим, что украшение 
                  должно не просто нравиться, а быть тем самым акцентом: 
                  завершающим элементом образа.
                </p>
                <p>
                  Мы работаем с крупными натуральными камнями — нефритом, 
                  агатом, кварцем, перламутром и другими минералами 
                  преимущественно от 8 мм и выше, чтобы изделия были 
                  по-настоящему заметны. Дополняем их металлом — 
                  бижутерным сплавом или гематитом — и совсем немного 
                  бисером и декоративными бусинами, там, где это нужно 
                  для баланса. Но что бы ни легло в основу, результат 
                  всегда один: украшение, которое не теряется рядом 
                  с вами, а становится тем самым акцентом. Каждый 
                  материал мы выбираем осознанно и всегда готовы 
                  рассказать, что именно у вас на запястье.
                </p>
              </motion.div>
