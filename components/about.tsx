            ...
            <div>
              ...
              >
                <p>
                  ...
                  вручную и без спешки. Мы верим, что украшение должно 
                  не просто нравиться, а быть сделано с пониманием того, 
                  из чего оно состоит.
                </p>
                <p>
                  Мы работаем с крупным натуральным камнем — нефритом, 
                  агатом, кварцем, перламутром и другими минералами 
                  от 8 мм и выше, чтобы камень был по-настоящему заметен, 
                  а не терялся в изделии. Дополняем его металлом — 
                  бижутерным сплавом или гематитом — и совсем немного 
                  бисером и декоративными бусинами, там, где это нужно 
                  для баланса. Каждый материал мы выбираем осознанно 
                  и всегда готовы рассказать, что именно у вас на запястье.
                </p>
              </motion.div>
